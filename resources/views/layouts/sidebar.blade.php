        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <x-sidebar-link :href="route('dashboard')" :active="request()->routeIs('dashboard')"
                    icon="<svg class='w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 22 21'>
