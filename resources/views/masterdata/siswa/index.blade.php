    ...
    <div class="bg-white rounded-lg text-gray-900 dark:text-gray-100 dark:bg-gray-800">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4 ">
            <div class="flex items-center justify-between">
                ...
                <div>
                    <button data-modal-target="imporSiswaModal" data-modal-toggle="imporSiswaModal" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 focus:ring-4 focus:ring-green-300 dark:bg-green-500 dark:hover:bg-green-600 focus:outline-none dark:focus:ring-green-800">
                        Import Data
                    </button>
            ...
            @include('masterdata.siswa.impor-modal')
            <table class="w-full mt-2 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <th scope="NIS" class="px-2 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            {{ $siswa->nis }}
                        </th>
                        <td class="px-6 py-2">
                            {{ $siswa->nisn }}
                        ...
                        <td class="px-2 py-2 relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" class="absolute right-0 z-10 mt-2 w-36 bg-white border rounded shadow-md">
                                <a href="{{ route('siswa.edit', $siswa->id) }}" class="w-full text-left block px-4 py-2 text-sm text-blue-600 hover:bg-gray-100">Edit</a>
